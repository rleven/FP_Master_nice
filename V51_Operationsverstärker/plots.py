...
params1, cov1 = curve_fit(fit,np.log(data1[4:, 0]), np.log(ampli(U_in_1, data1[4:,2])), p0=(1,1))
params2, cov2 = curve_fit(fit,np.log(data2[8:, 0]), np.log(ampli(U_in_2, data2[8:,2])), p0=(1,1))
params3, cov3 = curve_fit(fit,np.log(data3[7:, 0]), np.log(ampli(U_in_3, data3[7:,2])), p0=(1,1))
